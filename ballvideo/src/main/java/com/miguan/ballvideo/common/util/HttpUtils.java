...
//	}
	...
	public static void main(String[] args) throws Exception {
		...
		String url = "https://cdn.api.baishan.com/v2/cache/prefetch";
		paramsMap.put("token", "92815fee3499d1cf94d971f88e218f95");
		List<String> list = new ArrayList<>();
		list.add("http://xiyou.sc.diyixin.com/dev-video-xiyou/20190814/15657782473817.mp4");
		paramsMap.put("urls", list);
//		String [] urls = {"http://xiyou.sc.diyixin.com/dev-video-xiyou/20190814/15657782473817.mp4","http://xiyou.sc.diyixin.com/dev-video-xiyou/20190814/15657782473817.mp4"};
//
//		paramsMap.put("urls",urls );
		String s = postWithJson(url, JSON.toJSONString(paramsMap));
  ...
  public static String post(String url, String postBody) {
	...
	public static String postWithJson(String url, String postBody) {
		try {
			HttpClient client = new DefaultHttpClient();
			HttpPost post = new HttpPost(url);
